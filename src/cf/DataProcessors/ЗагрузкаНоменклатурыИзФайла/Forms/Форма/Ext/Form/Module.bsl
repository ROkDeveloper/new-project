...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ТоварыШтрихкод.Видимость = Форма.ЕстьКолонкаШтрихкод;
...
Процедура ЗаполнитьТаблицуТоваров(АдресРезультата)
	...
	ЕстьКолонкаШтрихкод = Результат.ЕстьКолонкаШтрихкод;
...
Функция ЗагрузитьНаСервере()
	...
	ПараметрыЗадания.Вставить("ЕстьКолонкаШтрихкод", ЕстьКолонкаШтрихкод);
