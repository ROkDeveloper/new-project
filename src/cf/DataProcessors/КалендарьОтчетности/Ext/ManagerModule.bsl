...
Функция ДанныеДляОтчета(Параметры) Экспорт
	...
	Если Не СообщенияОблачныхПриложений.ЭтоЗапросОтСлужебногоПользователя() Тогда
		Параметры.Организации = ОрганизацииЭтогоПриложенияДляКалендаря(Параметры.Пользователь);
	КонецЕсли;
...
Процедура ОбработатьОтветНаЗапросСпискаОрганизаций(СписокОрганизаций, Пользователь, Приложение, ПодключенныеОрганизации) Экспорт
...
Функция ОрганизацииЭтогоПриложенияДляКалендаря(Пользователь)
