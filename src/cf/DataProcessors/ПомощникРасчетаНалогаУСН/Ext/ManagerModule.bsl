...
Процедура ЗаполнитьАктуальныеПоказатели(Показатели)
	...
	// Для интеграции с банком уплаченные авансовые платежи приравниваем к исчисленным
	Если ЭтоИнтерфейсИнтеграцииСБанком
		И Показатели.НачалоПериода >= НастройкиУчетаКлиентСервер.ДатаПереходаНаЕдиныйНалоговыйПлатеж() Тогда
