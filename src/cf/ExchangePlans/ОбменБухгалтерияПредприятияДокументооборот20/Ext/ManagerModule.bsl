...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	ВариантНастройки.ИдентификаторНастройки        = "ОбменБПДО20";
...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Настройки.ЗаголовокПомощникаСозданияОбмена = НСтр("ru='Настройка синхронизации с 1С:Документооборотом КОРП, ред. 2'");
	Настройки.ЗаголовокУзлаПланаОбмена = НСтр("ru='Синхронизация с 1С:Документооборотом КОРП, ред. 2'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = 'Документооборот КОРП, редакция 2'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурациями ""Бухгалтерия предприятия КОРП"", ред. 3, и ""1С:Документооборот КОРП"", ред. 2.
...
Функция НастройкаОтборовНаУзлеБазыКорреспондента(ВерсияКорреспондента, ИмяФормы, ИдентификаторНастройки) Экспорт
	...
	СтруктураТабличнойЧастиСтороны = Новый Структура;
	СтруктураТабличнойЧастиСтороны.Вставить("Сторона", Новый Массив);
	СтруктураТабличнойЧастиСтороны.Вставить("Сторона_Ключ", Новый Массив);
	СтруктураНастроек.Вставить("ОграничиватьВыгрузку", Ложь);
	СтруктураНастроек.Вставить("Стороны", СтруктураТабличнойЧастиСтороны);
...
Функция ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента(ВерсияКорреспондента, ИмяФормы, ИдентификаторНастройки) Экспорт
	...
	СтруктураНастроек.Вставить("ГруппаДоступаКонтрагентов_Ключ", "");
