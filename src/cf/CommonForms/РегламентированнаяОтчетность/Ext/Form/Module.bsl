	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		ИначеЕсли ТекущиеДанные.НеОтправляетсяВКонтролирующийОрган
			...
			ИЛИ ТекущиеДанныеНаименованиеОтчета =
				"Заявление о предоставлении заключения о не выявленных (выявленных) фактах искажения затрат"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("предоставлении заключения")
			ИЛИ ТекущиеДанныеНаименованиеОтчета =
				"Уведомление о начале совершения (отказе от совершения) планируемых сделок"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("начале совершения (отказе")
			ИЛИ ТекущиеДанныеНаименованиеОтчета = "Запрос о предоставлении мотивированного мнения налогового органа"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.зап.мот.мнен.2024_1")
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЗначениеРеквизитаОбъекта(Ссылка, "ИмяФормы") =
				"Форма2024_1"
			ИЛИ ТекущиеДанныеНаименованиеОтчета = "Заявление об отзыве запроса о предоставлении мотивированного мнения"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.отз.мот.мнен.2024_1")
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЗначениеРеквизитаОбъекта(Ссылка, "ИмяФормы") =
				"Форма2024_1"
			ИЛИ ТекущиеДанныеНаименованиеОтчета = "Согласие с мотивированным мнением налогового органа"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.сог.мот.мнен.2024_1")
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЗначениеРеквизитаОбъекта(Ссылка, "ИмяФормы") =
				"Форма2024_1"
			ИЛИ ТекущиеДанныеНаименованиеОтчета = "Разногласия на мотивированное мнение налогового органа"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.раз.мот.мнен.2024_1")
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЗначениеРеквизитаОбъекта(Ссылка, "ИмяФормы") =
				"Форма2024_1"
			ИЛИ ТекущиеДанныеНаименованиеОтчета =
				"Согласие(несогласие) с мотивированным мнением налогового органа по результатам взаимосогласительной процедуры"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.взаимос.проц.2024_1")
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЗначениеРеквизитаОбъекта(Ссылка, "ИмяФормы") =
				"Форма2024_1" Тогда
