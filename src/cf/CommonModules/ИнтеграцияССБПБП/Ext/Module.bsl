...
Процедура ПриОпределенииДоступностиИнтеграцииПоДокументуОперации(ДокументОперации, Результат) Экспорт
	...
	ИначеЕсли ДанныеОснования.КонтрагентЮридическоеФизическоеЛицо <> Перечисления.ЮридическоеФизическоеЛицо.ФизическоеЛицо
...
Функция НастройкаИнтеграцииСБППоБанковскомуСчету(Организация, БанковскийСчет) Экспорт
	...
	НастройкаИнтеграции = НастройкаИнтеграцииСБППоБанку(Организация, Банк);
...
Процедура ВозвратОплаты(ПараметрыПроцедуры, АдресРезультата) Экспорт
	...
	Если ТипЗнч(ПараметрыПроцедуры.ДокументОплаты) = Тип("ДокументСсылка.СчетНаОплатуПокупателю")
		И ЗначениеЗаполнено(ПараметрыПроцедуры.ДокументОплаты) Тогда
		ДокументНаВозврат = Новый Структура("ДатаВозврата, СуммаВозврата");
		РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
			ПараметрыПроцедуры.ДокументОплаты, "СуммаДокумента, Дата");
		ДокументНаВозврат.СуммаВозврата = РеквизитыДокумента.СуммаДокумента;
		ДокументНаВозврат.ДатаВозврата  = РеквизитыДокумента.Дата;
	КонецЕсли;
