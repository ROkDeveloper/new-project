...
Процедура ДобавитьТекстЗапросаВТСведенийОВидахЗанятостиСотрудников(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ИсточникиДанных, ФормироватьСПериодичностьДень)
	...
	Если ИсточникиДанных.Получить("РегламентированныеСведенияОВидахЗанятостиСотрудников") <> Неопределено Тогда
		...
		ТекстЗапросДляРегламентированныхСведений =
			...
			|	МАКСИМУМ(СведенияОВидахЗанятости.Период) КАК МаксимальныйПериод
			|ПОМЕСТИТЬ ВТМаксимальныеПериодыРегламентированныхВидовЗанятости
			|ИЗ
			...
			|
			|СГРУППИРОВАТЬ ПО
			|	ОтборВнешнихСовместителей.Период,
			|	ОтборВнешнихСовместителей.Сотрудник,
			|	ОтборВнешнихСовместителей.ФизическоеЛицо
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	МаксимальныеПериодыРегламентированныхВидовЗанятости.Период КАК Период,
			|	МаксимальныеПериодыРегламентированныхВидовЗанятости.Сотрудник КАК Сотрудник,
			|	СведенияОВидахЗанятости.ВидЗанятости КАК ВидЗанятости
			|ПОМЕСТИТЬ ВТРегламентированныеСведенияОВидахЗанятостиСотрудников
			|ИЗ
			|	ВТМаксимальныеПериодыРегламентированныхВидовЗанятости КАК МаксимальныеПериодыРегламентированныхВидовЗанятости
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТРегламентированныеВидыЗанятостиСотрудников КАК СведенияОВидахЗанятости
			|		ПО МаксимальныеПериодыРегламентированныхВидовЗанятости.ФизическоеЛицо = СведенияОВидахЗанятости.ФизическоеЛицо
			|			И МаксимальныеПериодыРегламентированныхВидовЗанятости.МаксимальныйПериод = СведенияОВидахЗанятости.Период";
	...
	Если ИсточникиДанных.Получить("РегламентированныеСведенияОВидахЗанятостиСотрудников") <> Неопределено Тогда
		...
		КадровыйУчет.ДобавитьВКоллекциюИмяКадровыхДанных(ИсточникиДанных, "ВТКУничтожению", "ВТМаксимальныеПериодыРегламентированныхВидовЗанятости");
