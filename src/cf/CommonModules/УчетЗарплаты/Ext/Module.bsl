...
Функция УдержанныйПриВыплатеНДФЛ(Движения) Экспорт
	...
	Иначе
		...
		Колонки = "ВариантУдержания, ФизическоеЛицо, ДокументОснование, Сумма";
		...
		Для Каждого СтрокаТаблицыДвижений Из ТаблицаДвижений Цикл
			Если СтрокаТаблицыДвижений.Сумма < 0 Тогда
				...
				НоваяСтрока.Сумма = -СтрокаТаблицыДвижений.Сумма;
			КонецЕсли;
		КонецЦикла;
...
Функция УдержанныйНДФЛПоДаннымВедомостейНаВыплатуЗарплаты(Ведомости)
	...
	|	СУММА(ВедомостьНаВыплатуЗарплатыНДФЛ.Сумма + ВедомостьНаВыплатуЗарплатыНДФЛ.СуммаСПревышения) КАК Сумма
	|ИЗ
