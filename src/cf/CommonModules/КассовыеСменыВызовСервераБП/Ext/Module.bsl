...
//
Функция ДанныеЗакрытияКассовойСмены(РабочееМесто, КлючФормы, КомпоновщикНастроек = Неопределено, ИдентификаторУстройства = Неопределено) Экспорт
...
Функция ОткрытыеСмены(РабочееМесто, ИдентификаторУстройства = Неопределено)
	...
	|	И КассоваяСмена.ФискальноеУстройство = &ИдентификаторУстройства
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ
	...
	Иначе
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "КассоваяСмена.ФискальноеУстройство = &ИдентификаторУстройства", "ИСТИНА");
