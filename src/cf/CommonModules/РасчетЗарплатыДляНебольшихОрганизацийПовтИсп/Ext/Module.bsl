...
Функция ДатыВыплатыОрганизации(Организация, МесяцНачисления) Экспорт
	...
	ДатыВыплаты.Аванс    = УчетЗарплаты.БлижайшийРабочийДеньДляВыплаты(Организация,    ДатыВыплаты.Аванс);
	ДатыВыплаты.Зарплата = УчетЗарплаты.БлижайшийРабочийДеньДляВыплаты(Организация, ДатыВыплаты.Зарплата);
