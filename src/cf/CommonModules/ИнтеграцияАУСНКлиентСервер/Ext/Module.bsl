...
Функция ИменаМетодовВзаимодействияИнтеграцияСЛК() Экспорт
	...
	ИменаМетодов.Вставить("СоздатьТокенАвторизацииЛКАУСН", "СоздатьТокенАвторизацииЛКАУСН");
...
Функция НовыеПараметрыМетодаВзаимодействия(МетодВзаимодействия) Экспорт
	...
	ИначеЕсли МетодВзаимодействия = ИменаМетодовВзаимодействияИнтеграцияСЛК().СоздатьТокенАвторизацииЛКАУСН Тогда
