...
Процедура ЗаполнитьРеквизитыКонтрагента(Реквизиты, Контрагент, Период)
	...
	ИменаРеквиизтовКонтрагентаИП = "ИндивидуальныйПредприниматель";
	ИменаРеквизитовПредпринимателяРасширенное = ИменаРеквизитовПредпринимателя + ", " + ИменаРеквиизтовКонтрагентаИП;
	ИменаРеквизитовОбъекта = "ЮридическоеФизическоеЛицо, Представление, ИНН, КодПоОКПО, РегистрационныйНомер, "
		+ "СтранаРегистрации, НалоговыйНомер, " + ИменаРеквизитовПредпринимателяРасширенное;
