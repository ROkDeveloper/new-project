...
Процедура ПолучитьУстройстваUSB(
		ОповещениеОЗавершении,
		ВыводитьСоообщения,
		МенеджерКриптографии,
		АлгоритмИлиСертификат) Экспорт
	...
	ПредварительноСоздатьМенеджерКриптографии(
		ОповещениеОЗавершении, "ПолучитьУстройстваUSBПослеСозданияМенеджераКриптографии",,
		ВыводитьСоообщения, МенеджерКриптографии, ПараметрыОпределенияАлгоритма);
...
Процедура УстановитьОбработчикСобытия(
		ОповещениеОЗавершении,
		Фильтр,
		ВыводитьСоообщения,
		МенеджерКриптографии,
	...
	ВходящиеПараметры = ПараметрыВМассив(1, Фильтр);
	...
	ПредварительноСоздатьМенеджерКриптографии(
		ОповещениеОЗавершении, "УстановитьОбработчикСобытияПослеСозданияМенеджераКриптографии",
		ВходящиеПараметры, ВыводитьСоообщения, МенеджерКриптографии, ПараметрыОпределенияАлгоритма);
