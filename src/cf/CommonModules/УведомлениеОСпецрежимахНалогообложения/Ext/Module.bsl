...
Процедура Проверка_УдЛичнФЛ(Показатели, Данные, ТаблицаОшибок, ИмяСтраницы, Обязательность = Ложь) Экспорт
	...
	Если Обязательность Или БлокЗаполнен(Данные, Показатели) Тогда
...
Процедура ЗапретитьРедактированиеРеквизитовСданногоОтчета(Форма)
	...
	ЗапретитьРедактированиеПользователем = ((СтрНачинаетсяС(СтатусОтправки, "Сдано")
		...
		ИЛИ СтатусОтправки = "Сдано, требует уточнения") И СтрНайти(СтатусОтправки, СтатусОтправкиВЖурнале) = 1;
...
Функция ДопСтрокиДляСохранения(Форма) Экспорт 
