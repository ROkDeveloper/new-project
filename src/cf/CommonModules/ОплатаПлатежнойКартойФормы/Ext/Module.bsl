...
Процедура ПодготовитьФормуНаСервере(Форма)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Форма, "ЭтоВозвратПоСБП") Тогда
		МассивРеквизитов = Новый Массив;
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ЭтоВозвратПоСБП",             Новый ОписаниеТипов("Булево")));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ДоступностьВозвратПоСБП",     Новый ОписаниеТипов("Булево")));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ВозвратСредствПоСБПВыполнен", Новый ОписаниеТипов("Булево")));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ТекстПредупрежденияСБП",      ОбщегоНазначения.ОписаниеТипаСтрока(0)));
