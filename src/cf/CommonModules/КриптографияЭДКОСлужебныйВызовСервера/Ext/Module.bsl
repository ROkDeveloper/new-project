...
Функция ПрочитатьOID2_5_29_16(ОбъектЧтениеДанных, СвойстваСертификата)
	...
	Если СвойстваБлока.Класс = "UNIVERSAL" И СвойстваБлока.Тег = Типы().SEQUENCE Тогда
		...
		КлючДействителенС = ДокументооборотСКОВызовСервера.ДатаИзСтрокиРазныхФорматов(КлючДействителенС);
		...
		КлючДействителенПо = ДокументооборотСКОВызовСервера.ДатаИзСтрокиРазныхФорматов(КлючДействителенПо);
