...
Процедура ФайлыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ФайлыИмяФайлаПриложения" Тогда
		...
		Если НЕ ТекущиеДанные.ФайлПриложенияСсылка.Пустая() Тогда
			...
			Если ЭлектронныйДокументооборотСФССКлиент.ЭтоФайлPDF(ДанныеФайла) Тогда
				РаботаСФайламиКлиент.ОткрытьФайл(ДанныеФайла, Ложь);
			Иначе
				ТекстСообщения = НСтр("ru = 'Открыть файл требования невозможно. С сервера СФР получен некорректный файл pdf.'");
