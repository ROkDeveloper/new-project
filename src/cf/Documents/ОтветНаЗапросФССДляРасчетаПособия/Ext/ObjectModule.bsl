...
Функция ДанныеЗаполняемыеИзПервичногоДокумента()
	...
	Если ДанныеВходящегоЗапроса <> Неопределено Тогда
		...
		Если  ЗначениеЗаполнено(ДанныеВходящегоЗапроса.ПервыйРасчетныйГодВидЗаработка)
			И ЗначениеЗаполнено(ДанныеВходящегоЗапроса.ВторойРасчетныйГодВидЗаработка)
			И (ПриоритетУДанныхВходящегоЗапроса Или ИзмененРасчетныйПериод) Тогда
...
Функция ДополнитьДаннымиВходящегоЗапроса(ПараметрыФиксации, Принудительно = Ложь)
	...
	Если ЗначениеЗаполнено(РеквизитыЗапроса.ПервыйРасчетныйГодВидЗаработка)
		И ЗначениеЗаполнено(РеквизитыЗапроса.ВторойРасчетныйГодВидЗаработка) Тогда
