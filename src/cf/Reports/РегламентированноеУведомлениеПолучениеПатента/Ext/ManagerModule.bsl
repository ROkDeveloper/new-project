...
Функция СформироватьВыгрузкуИПолучитьДанные(ДокОбъект) Экспорт 
	...
	ИначеЕсли ДокОбъект.ИмяФормы = "Форма2020_1" Тогда 
	...
	ИначеЕсли ДокОбъект.ИмяФормы = "Форма2017_1" Тогда 
		...
		СтруктураВыгрузки.Вставить("ИмяФайла", "1150010_5.07000_07.tif");
		Возврат СтруктураВыгрузки;
	ИначеЕсли ДокОбъект.ИмяФормы = "Форма2016_1" Тогда 
		СтруктураВыгрузки.Вставить("Данные", УведомлениеОСпецрежимахНалогообложения.ПолучитьМакетДвоичныхДанных(ДокОбъект.ИмяОтчета, "TIFF_2016_1"));
		СтруктураВыгрузки.Вставить("ИмяФайла", "1150010_5.06000_06.tif");
		Возврат СтруктураВыгрузки;
	ИначеЕсли ДокОбъект.ИмяФормы = "Форма2015_1" Тогда 
		...
		СтруктураВыгрузки.Вставить("ИмяФайла", "1150010_5.05000_05.tif");
		Возврат СтруктураВыгрузки;
	КонецЕсли;
КонецФункции
