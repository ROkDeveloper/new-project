...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Форма № 3-ТРАНСПОРТ утверждена Указанием Банка России от 25.11.2019 № 5328-У.";
	НоваяФорма.РедакцияФормы      = "от 25.11.2019 № 5328-У.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма2022Кв1 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
		"0414008", '2019-11-25', "5328-У", "ФормаОтчета2022Кв1");
