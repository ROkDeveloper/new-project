...
Процедура ПроверкаКС_17_1_1_к()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru='17.1.1.к'"));
...
Процедура ПроверкаКС_17_1_2_к()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='17.1.2.к'"));
...
Процедура ПроверкаКС_17_1_3_к()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='17.1.3.к'"));
...
Процедура ПроверкаКС_17_2_к()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='17.2.к'"));
...
Процедура ПроверкаКС_17_3_к()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='17.3.к'"));
