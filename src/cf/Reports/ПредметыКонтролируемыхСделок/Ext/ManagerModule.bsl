...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Сведения о предметах контролируемых сделок";
...
Функция ПолучитьВнешниеНаборыДанных(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	СписокПустыхПредметовСделок.Добавить(Справочники.ОсновныеСредства.ПустаяСсылка());
	...
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК ЯвляетсяТоваромМировойБиржевойТорговли,
	|	ПредметыКонтролируемыхСделок.ОблагаетсяНДПИПоПроцентнойСтавке КАК ОблагаетсяНДПИПоПроцентнойСтавке,
	...
	|		ПО ПредметыКонтролируемыхСделокРегистр.ПредметСделки = ПредметыКонтролируемыхСделок.ПредметСделки
