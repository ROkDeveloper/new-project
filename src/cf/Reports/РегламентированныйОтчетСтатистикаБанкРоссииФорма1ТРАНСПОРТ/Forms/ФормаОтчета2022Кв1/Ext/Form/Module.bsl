...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел2", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел2"]);
	Контейнер.Вставить("Раздел31", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
	Контейнер.Вставить("Раздел32", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел32"]);
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел2"] = Контейнер["Раздел2"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"] = Контейнер["Раздел31"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел32"] = Контейнер["Раздел32"];
