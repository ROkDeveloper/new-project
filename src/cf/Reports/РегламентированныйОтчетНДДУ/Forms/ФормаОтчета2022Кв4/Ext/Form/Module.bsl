...
&НаСервере
Процедура ПроверкаКС_5_1_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='5.1.1.к'"));
...
&НаСервере
Процедура ПроверкаКС_5_1_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='5.1.2.к'"));
...
&НаСервере
Процедура ПроверкаКС_5_2_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='5.2.1.к'"));
...
&НаСервере
Процедура ПроверкаКС_5_2_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='5.2.2.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.040 Раздела 1 = стр.|150 - 160| Раздела 2, если стр.020 Раздела 1 = стр.005 '") +
	...
	Для каждого КБКРаздела1 Из ДанныеКС.КБК_Раздел1 Цикл 
		...
		РасчетнаяСумма = - Мин(0, Показатели.Р2С150.Итог - Показатели.Р2С160.Итог);
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р1С040.Итог = 0 И НЕ Показатели.Р1С040.Итог = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Р1С040.Итог, РасчетнаяСумма, Показатели.Р2С150.Итог, Показатели.Р2С160.Итог, КБКРаздела1Стр); 
		ДополнитьТаблицуРезультата();
