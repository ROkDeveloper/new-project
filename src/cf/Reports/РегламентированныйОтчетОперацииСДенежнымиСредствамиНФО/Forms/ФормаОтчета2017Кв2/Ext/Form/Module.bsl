...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "01/05/2017";
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СпискиВыбора2017Кв2");
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяСхемыВыгрузки", "СхемаВыгрузки2017Кв2_" + Постфикс);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если НЕ (ПараметрыВыгрузки.КодОснВидаДеятельности = "120"
		...
		ИЛИ ПараметрыВыгрузки.ВидДеятельностиНФО = "Кредитный потребительский кооператив"))
		И ПараметрыВыгрузки.КодОснВидаДеятельности <> "180" Тогда
...
Процедура ВывестиНаПечатьОтчет(СтруктураПараметров, ВыбранныеСтраницы, СтрПоля = Неопределено)
	...
	ИмяМакета = "ПечатныйБланк2017Кв2";
