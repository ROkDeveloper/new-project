...
Процедура СформироватьТаблицуКодовСтран(ИмяПоказателя)
	...
	Если ИмяПоказателя <> "П1300001" Тогда
		...
		+ "международной компании в соответствии со статьей 5 Федерального закона от 03.08.2018 N 290-ФЗ ""О международных "
		+ "компаниях и международных фондах"" (Собрание законодательства РФ, 2018, N 32, ст. 5083; N 53, ст. 8411)";
		НовСтр = Результат.Добавить();
		НовСтр.Код = "997";
