...
#Область Проверки
	...
	ПроверкаКС_14_1_01_к();
	ПроверкаКС_14_1_02_к();
	ПроверкаКС_14_1_03_к();
	ПроверкаКС_14_1_04_к();
	ПроверкаКС_14_1_05_к();
	ПроверкаКС_14_1_06_к();
	ПроверкаКС_14_1_07_к();
	ПроверкаКС_14_1_08_к();
	ПроверкаКС_14_1_09_к();
	ПроверкаКС_14_1_10_к();
	ПроверкаКС_14_1_11_к();
	ПроверкаКС_14_1_12_к();
	ПроверкаКС_14_1_13_к();
	ПроверкаКС_14_1_14_к();
	ПроверкаКС_14_1_15_к();
	ПроверкаКС_14_1_16_к();
	ПроверкаКС_14_1_17_к();
	ПроверкаКС_14_2_к();
	ПроверкаКС_14_3_к();
	ПроверкаКС_14_5_к();
	ПроверкаКС_14_6_к();
...
&НаСервере
Процедура ПроверкаКС_14_1_01_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.01.к'"));
	...
	ПроверкаКС_14_1_01_к_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_14_1_01_к_код()
...
&НаСервере
Процедура ПроверкаКС_14_1_02_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.02.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_03_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.03.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_04_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.04.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_05_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.05.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_06_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.06.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_07_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.07.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_08_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.08.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_09_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.09.к'"));
	...
	ПроверкаКС_14_1_09_к_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_14_1_09_к_код()
...
&НаСервере
Процедура ПроверкаКС_14_1_10_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.10.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_11_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.11.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_12_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.12.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_13_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.13.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_14_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.14.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_15_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.15.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_16_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.16.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_1_17_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.1.17.к'"));
...
&НаСервере
Процедура ПроверкаКС_14_3_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1.2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='14.3.к'"));
...
Процедура ПроверкаКС_14_7_к()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Стр.280 Раздела 2.2 = '") +
		НСтр("ru='стр.(020 + 040 + 070 + 100 + 120) Раздела 1.2 - стр.(050 + 080 + 110) Раздела 1.2, '") +
		НСтр("ru='стр.280 Раздела 2.2 > стр.273 Раздела 2.2 и стр.101 Раздела 1.2 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 ((%3 + %4 + %5 + %6 + %7) - (%8)), если %1 > %9'"));
